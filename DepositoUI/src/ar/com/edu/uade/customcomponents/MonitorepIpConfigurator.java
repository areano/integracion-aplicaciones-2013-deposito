...
public class MonitorepIpConfigurator extends CustomComponent {
	 ...
	 * visual editor.
	 */
	public MonitorepIpConfigurator(String group, HashMap<Integer, ConnectionView> actualSet) {
	...
	private void configureLabel(String label){
	 ...
	 protected void addNewIP(String newID, String newIP, boolean synchronic){
		 ...
		 if (synchronic)  {
			 groupValue =  "ID: "+newID+" - IP:"+newIP+": Sincronico";
			 sync = true;
		 }
		 else 
			 groupValue =  "ID: "+newID+" - IP:"+newIP+": Asincronico";
