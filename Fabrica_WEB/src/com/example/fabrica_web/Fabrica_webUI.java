package com.example.fabrica_web;
...
import ar.com.edu.uade.depositoui.DepositoUI;
import ar.com.edu.uade.depositoui.HelpManager;
...
//	 }
	...
	private static final Logger logger = Logger.getLogger(DepositoUI.class
			.getName());
	...
	HashMap<String, Class<? extends View>> routes = new HashMap<String, Class<? extends View>>() {
		{
			put("/versolicitudespendientes",
					ar.com.edu.uade.view.EnviarPedidosADespachoView.class);
	...
	private void buildLoginView(boolean exit) {
		...
		Label title = new Label("Administrador Deposito <span>Grupo 6</span>",
				ContentMode.HTML);
	...
	private void buildMainView() {
		...
		for (final String view : new String[] { "creararticulo",
				"crearconfiguracion", "crearpedidoafabrica",
			...
			if (view.equals("crearpedidoafabrica")) {
				...
				reports.setDropHandler(new DropHandler() {
					...
					public void drop(DragAndDropEvent event) {
						clearMenuSelection();
						viewNameToMenuButton.get("/crearpedidoafabrica")
		...
		viewNameToMenuButton.get("/versolicitudespendientes")
				.setHtmlContentAllowed(true);
		viewNameToMenuButton.get("/versolicitudespendientes").setCaption(
				"Solicitudes<span> pendientes</span>");
		...
		nav.addViewChangeListener(new ViewChangeListener() {
			...
			public void afterViewChange(ViewChangeEvent event) {
				...
				// if (autoCreateReport && newView instanceof
				// CrearPedidoAFabricaView) {
				//
				// }
	...
	void updateReportsButtonBadge(String badgeCount) {
		viewNameToMenuButton.get("/crearpedidoafabrica").setHtmlContentAllowed(
				true);
