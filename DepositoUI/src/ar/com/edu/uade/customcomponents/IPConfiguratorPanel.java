...
public class IPConfiguratorPanel extends CustomComponent {
	 ...
	 * @param portales 
	 */
	public IPConfiguratorPanel(HashMap<String, String> portales, HashMap<String, String> despachos, HashMap<String, String> monitoreo,
			HashMap<String, String> fabrica) {
	...
	@AutoGenerated
	private AbsoluteLayout buildMainLayout(HashMap<String, String> portales, HashMap<String, String> despachos, 
			HashMap<String, String> monitoreo, HashMap<String, String> fabrica) {
	...
	@AutoGenerated
	private GridLayout buildGridLayout_1(HashMap<String, String> portales, HashMap<String, String> despachos, 
			HashMap<String, String> monitoreo, HashMap<String, String> fabrica) {
		// common part: create layout
		...
		// ipConfigurator_1
		ipConfigurator_1 = new IpConfigurator("Portales", portales);
		...
		// ipConfigurator_2
		ipConfigurator_2 = new IpConfigurator("Despachos", despachos);
...
//		gridLayout_1.addComponent(ipConfigurator_3, 0, 1);
		ipConfigurator_3 = new MonitorepIpConfigurator("Monitoreo", monitoreo);
		ipConfigurator_3.setImmediate(false);
		ipConfigurator_3.setWidth("-1px");
		ipConfigurator_3.setHeight("-1px");
		gridLayout_1.addComponent(ipConfigurator_3, 0, 1);
//		// ipConfigurator_4
		ipConfigurator_4 = new IpConfigurator("Fabrica", fabrica);
