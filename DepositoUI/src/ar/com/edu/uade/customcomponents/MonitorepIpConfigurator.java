...
public class MonitorepIpConfigurator extends CustomComponent {
		...
		public AddNewIPWindow() {
	        ...
	        Button ok = new Button("OK",new Button.ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					...
					if (((String)selectSyncro.getValue()).toUpperCase() == "SINCRONICO"){
						synchronic = true;
					}else{
						synchronic = false;
					}
	...
	private HashMap<String, String> mappedIPs;
	/**
	 ...
	 * visual editor.
	 */
	public MonitorepIpConfigurator(String group, HashMap<String, String> actualSet) {
		mappedIPs = new HashMap<String, String>();
		buildMainLayout();
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(button_1, "top:154.0px;left:222.0px;");
	...
	private void configureGroupBox(HashMap<String, String> actualSet){
		optionGroup_2.setMultiSelect(true);
		String groupValue =  new String();
		
		for (String key:actualSet.keySet()){
			groupValue = "ID: "+key+" - IP:"+actualSet.get(key);
			optionGroup_2.addItem(groupValue);
			mappedIPs.put(groupValue,key);
		}
	}
	private void configureLabel(String label){
	 ...
	 protected void addNewIP(String newID, String newIP, boolean synchronic){
		 ...
		 if (synchronic)  
			 groupValue.concat(" : Sincronico");
		 else 
			 groupValue.concat(" : Asincronico");
		 optionGroup_2.addItem(groupValue);
		 mappedIPs.put(groupValue,newID);
	 }
